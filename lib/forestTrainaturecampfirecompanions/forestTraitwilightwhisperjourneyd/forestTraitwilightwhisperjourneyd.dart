                                ...
                                InkWell(
                                  onTap: () async {
                                    forestTraiinterstellarJourneyebvigto(
                                      context: context,
                                      quantumPortalPath:
                                          '${'194defe1f0d09e76029210070a6682eae72ffe197fac5c02593f1c46756b49be'.forestTraishieldDecode()}',
                                    ...
                                    return InkWell(
                                      onTap: () async {
                                        forestTraiinterstellarJourneyebvigto(
                                          context: context,
                                          quantumPortalPath:
                                              '${'564906f4dd2ce49dc3a84eb1c66ead010431e2a0a860ea4775e7f87b83667743'.forestTraishieldDecode()}',
                                          cosmicQueryParams: {
                                            '${'3e460e473d3b9f93f75c3ee5be2bbbe9'.forestTraishieldDecode()}':
                                                digitalAdventureCircleItem[
                                                        '${'65e9fc18d908f0807f9ec72f4bd68071'.forestTraishieldDecode()}'][0]
                                                    [
                                                    '${'dfe5212b8000049891f63718b7573c7ebd2e9bc8302e24ec1fa17aa9b94ab87e'.forestTraishieldDecode()}'],
                                          },
                                                    ...
                                                    image: DecorationImage(
                                                      ...
                                                      image: Image.network(
                                                              digitalAdventureCircleItem[
                                                                      '${'65e9fc18d908f0807f9ec72f4bd68071'.forestTraishieldDecode()}'][0]
                                                                  [
                                                                  '${'7dd4c03fc0f61cb54548b66556e07655'.forestTraishieldDecode()}'])
                                                          .image,
                                                    ),
                                                    borderRadius:
                                                      ...
                                                      children: [
                                                        Text(
                                                          digitalAdventureCircleItem[
                                                                  '${'65e9fc18d908f0807f9ec72f4bd68071'.forestTraishieldDecode()}'][0]
                                                              [
                                                              '${'c5d7233e28081d3b82e53afe2708fb12'.forestTraishieldDecode()}'],
                                                          style: TextStyle(
                                                            color: Color(
                                                                0xFF323232),
                                                            fontSize: 16,
                                                        ...
                                                        Text(
                                                          digitalAdventureCircleItem[
                                                                      '${'65e9fc18d908f0807f9ec72f4bd68071'.forestTraishieldDecode()}'][0]
                                                                  [
                                                                  '${'a8f65b26df8fde5db0fda5ca4dfaa42b1411c65d5d5d02b1f08b33566c832406'.forestTraishieldDecode()}']
                                                              .toString(),
                                                          style: TextStyle(
                                                            color: Color(
                                                                0x80000000),
                                                ...
                                                Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                        DateFormat(
                                                                '${'a445ec2957de71b324a4073646346c2f'.forestTraishieldDecode()}')
                                                            .format(DateTime.fromMillisecondsSinceEpoch(
                                                                digitalAdventureCircleItem[
                                                                            '${'65e9fc18d908f0807f9ec72f4bd68071'.forestTraishieldDecode()}'][0]
                                                                        [
                                                                        '${'72f570d9d57e8520e8d5423e31a94120'.forestTraishieldDecode()}']
                                                                    as int)),
                                                        style: TextStyle(
                                                          color:
                                                              Color(0xFF979797),
