  ...
  void initState() {
    ...
    _controller
      ...
      ..addJavaScriptChannel(
          "${'18da43c1a437064a275836391df655c32093f12e26313f63cd7dfd67cc0a769b'.forestTraishieldDecode()}",
          onMessageReceived: (message) {
        String tiaozhuan;
        if (message.message.contains("?")) {
          tiaozhuan =
              "${message.message}&${inclusiveExperienceCoordinator().campfireJourneyToken}${'07460cd5c3d487c2432e5a8f4ba0bdd9'.forestTraishieldDecode()}${57624642}";
        } else {
          tiaozhuan =
              "${message.message}?${inclusiveExperienceCoordinator().campfireJourneyToken}${'07460cd5c3d487c2432e5a8f4ba0bdd9'.forestTraishieldDecode()}${57624642}";
        }
      ...
      ..addJavaScriptChannel(
          "${'6991759fa48f3ab7208e4d6fea9f67a40727cfa98eb82934c4ae352b9546d7ee'.forestTraishieldDecode()}",
          onMessageReceived: (message) {
        context.go(
            '${'6947776c51f89b31389a0f77656e57d37f220e29176b5f5591d9f3c71cd0d79d'.forestTraishieldDecode()}');
      })
      ..addJavaScriptChannel(
          '${'c8f8bc32c3443d6526b13b2cebe7833e5650a5dca1585f915f5dc9281ed7e42e'.forestTraishieldDecode()}',
          onMessageReceived: (message) {
        context.pop(true);
      })
      ..addJavaScriptChannel(
          "${'805c1dffea4b39e39fc7459f7516442472325195fe79c153484637598982320a'.forestTraishieldDecode()}",
          onMessageReceived: (message) async {
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                              "${'f1e2e0ec1de6b94d5194e874b1c00982d1fa2d6bc0cb9bfa54f330f98c2be7280e736abff35e305bc217c470ce3a9a2d'.forestTraishieldDecode()}",
                          ...
                          ElevatedButton(
                            ...
                            child: Text(
                              "${'d501094aad7d04ea682ce1f3f6254efe'.forestTraishieldDecode()}",
                              style: const TextStyle(
                                fontSize: 16,
                                color: Colors.white,
                                fontWeight: FontWeight.bold,
