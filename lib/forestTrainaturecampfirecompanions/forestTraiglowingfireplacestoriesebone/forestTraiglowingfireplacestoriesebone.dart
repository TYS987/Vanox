        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Builder(
                  builder: (context) => Padding(
                    ...
                    child: InkWell(
                      ...
                      child: FutureBuilder(
                         future: forestTraiwildEchoVoiceCluster.forestTraicampBondVoiceJourney('moonlitWhisperCoEncountersy.png'),   
              ...
              Spacer(),
              FutureBuilder(
                future: forestTraiwildEchoVoiceCluster.forestTraicampBondVoiceJourney('natureInspiredConversations.png'),   
                builder: (context, asyncSnapshot) {
                  if (!asyncSnapshot.hasData) return const SizedBox();      
                  return Container(
                    width: 98.0,
                      ...
                      builder: (context) {
                        if (inclusiveExperienceCoordinator().outdoorAdventureDialogues == 0) {
                          ...
                          return InkWell(
                            ...
                            child: FutureBuilder(
                              future: forestTraiwildEchoVoiceCluster.forestTraicampBondVoiceJourney('mountainConversationriverside.png'),  
                              builder: (context, asyncSnapshot) {
                                if (!asyncSnapshot.hasData) return const SizedBox(); 
                                return Container(
                                  width: 15.0,
