                            ...
                            child: InkWell(
                              onTap: () async {
                                interstellarJourneyWebNavigator(
                                  context: context,
                                  quantumPortalPath:
                                      '${'3d43c4e0311304a3c9bd84f1ec03325e34782e17e0d1bba022671aaf51e3eeae'.shieldDecode()}',
                                );
                              },
                              child: FutureBuilder(
                                  future:
                                      wildEchoVoiceCluster.campBondVoiceJourney(
                                                                ...
                                                                child: Row(
                                                                  ...
                                                                  children: [
                                                                    Expanded(
                                                                      child:
                                                                          Text(
                                                                        digitalMemoryCollectorItem['${'11bb639e33bb4aa460d41e4af0eb1ae1'.shieldDecode()}']
                                                                            .toString(),
                                                                        style:
                                                                            TextStyle(
                                                                          color:
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                          FutureBuilder(
                                                                               future: wildEchoVoiceCluster.campBondVoiceJourney('rusticConnectionCircle.png'), 
                                                                            builder: (context, asyncSnapshot) {
                                                                              if (!asyncSnapshot.hasData) return const SizedBox();   
                                                                              return Container(
                                                                                                                                                      width:
                                                ...
                                                child: ClipRRect(
                                                  ...
                                                  child: CachedNetworkImage(
                                                    imageUrl: inclusiveExperienceCoordinator()
                                                        .starlitCampfireJourneyPosts
                                                        .toList()[0][
                                                            '${'f92e0df6780b073ae54d3b8c55ac86e0'.shieldDecode()}']
                                                            [0]
                                                        .toString(),
                                                    width: 163.0,
                                                    height: 160.0,
                                                                ...
                                                                children: [
                                                                  ClipRRect(
                                                                    ...
                                                                    child:
                                                                        CachedNetworkImage(
                                                                      imageUrl:
                                                                          wildernessFriendshipCircleItem['${'a9d45d6e9423bd33032e08940ab216fb'.shieldDecode()}']
                                                                              .toString(),
                                                                      width:
                                                                          145,
                                                                      height:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              FutureBuilder(
                                                                                  future: wildEchoVoiceCluster.campBondVoiceJourney('sunriseCampfireHarmony.png'),
                                                                                  builder: (context, asyncSnapshot) {
                                                                                    if (!asyncSnapshot.hasData) return const SizedBox();
                                                                                    return Container(
                                                                                      width: 8.3,
                                                                              ...
                                                                              Text(
                                                                                wildernessFriendshipCircleItem['${'1874cdef85bd20bd44812d94e57f43d9'.shieldDecode()}'].toString(),
                                                                                style: TextStyle(
                                                                                  color: Colors.white,
                                                                                  fontSize: 7,
                                                                                  letterSpacing: 0.0,
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      padding: EdgeInsetsDirectional
                                                                          .fromSTEB(
                                                                              ...
                                                                              5),
                                                                      child: FutureBuilder(
                                                                          future: wildEchoVoiceCluster.campBondVoiceJourney('glowingEmberFriendship.png'),
                                                                          builder: (context, asyncSnapshot) {
                                                                            if (!asyncSnapshot.hasData)
                                                                              return const SizedBox();
                                                                            return Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        InkWell(
                                          onTap: () async {
                                            interstellarJourneyWebNavigator(
                                              context: context,
                                              quantumPortalPath:
                                                  '${'ee260e2fc46139f3d47d58ead26e3fadf18588f59a9953cb38ee202ace29845a'.shieldDecode()}',
                                            );
                                          },
                                          child: FutureBuilder(
                                                future: wildEchoVoiceCluster.campBondVoiceJourney('moonriseFriendshipLounge.png'),
                                            builder: (context, asyncSnapshot) {
                                              if (!asyncSnapshot.hasData) return const SizedBox();     
                                              return Container(
                                                width: 162.0,
                                        ...
                                        InkWell(
                                          ...
                                          child: FutureBuilder(
                                             future: wildEchoVoiceCluster.campBondVoiceJourney('lakesideJourneySharing.png'),   
                                            builder: (context, asyncSnapshot) {
                                              if (!asyncSnapshot.hasData) return const SizedBox();      
                                              return Container(
                                                width: 162.0,
