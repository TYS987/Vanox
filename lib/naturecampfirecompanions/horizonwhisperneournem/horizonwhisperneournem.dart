                                  ...
                                  builder: (context) {
                                    if (moonriseFriendswilderness == 0) {
                                      return FutureBuilder(
                                          future: wildEchoVoiceCluster.campBondVoiceJourney('voyagerFriendshipCircle.png'),   
                                        builder: (context, asyncSnapshot) {
                                          if (!asyncSnapshot.hasData) return const SizedBox();     
                                          return Container(
                                            width: 200,
                            ...
                            Row(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  child: FutureBuilder(
                                       future:  moonriseFriendswilderness == 0 ? wildEchoVoiceCluster.campBondVoiceJourney('scenicOutdoorFriendship.png') :wildEchoVoiceCluster.campBondVoiceJourney('scenicOutdoorFriendships.png') ,
                                    builder: (context, asyncSnapshot) {
                                      if (!asyncSnapshot.hasData) return const SizedBox();    
                                      return Container(
                                        width: 120.0,
                                ...
                                InkWell(
                                  ...
                                  child: FutureBuilder(
                                       future: moonriseFriendswilderness ==
                                                        1 ? wildEchoVoiceCluster.campBondVoiceJourney('forestWhisperNetworkings.png') : wildEchoVoiceCluster.campBondVoiceJourney('forestWhisperNetworking.png'),         
                                    builder: (context, asyncSnapshot) {
                                      if (!asyncSnapshot.hasData) return const SizedBox();            
                                      return Container(
                                        width: 140.0,
                ...
                child: Row(
                  ...
                  children: [
                    InkWell(
                      ...
                      child: FutureBuilder(
                          future: wildEchoVoiceCluster.campBondVoiceJourney('rusticPathDialogues.png'),  
                        builder: (context, asyncSnapshot) {
                          if (!asyncSnapshot.hasData) return const SizedBox();        
                          return Container(
                            width: 113.0,
                    ...
                    Row(mainAxisSize: MainAxisSize.max, children: [
                      InkWell(
                        ...
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 0.0, 6.0, 0.0),
                          child: FutureBuilder(
                              future: wildEchoVoiceCluster.campBondVoiceJourney('wildernessFriendshipLounge.png'),   
                            builder: (context, asyncSnapshot) {
                              if (!asyncSnapshot.hasData) return const SizedBox();   
                              return Container(
                                width: 36.0,
                      ...
                      InkWell(
                        ...
                        child: FutureBuilder(
                    future: wildEchoVoiceCluster.campBondVoiceJourney('glowingCampfireCommunity.png'), 
                          builder: (context, asyncSnapshot) {
                            if (!asyncSnapshot.hasData) return const SizedBox();      
                            return Container(
                              width: 36.0,
