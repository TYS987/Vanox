...
Widget wrapWithModel<T extends AccessibilityFeatureDesignerModel>({
  required T model,
...
T createModel<T extends AccessibilityFeatureDesignerModel>(
...
abstract class AccessibilityFeatureDesignerModel<W extends Widget> {
  ...
  AccessibilityFeatureDesignerModel setOnUpdate({
    bool updateOnChange = false,
...
class AccessibilityFeatureDesignerDynamicModels<T extends AccessibilityFeatureDesignerModel> {
  AccessibilityFeatureDesignerDynamicModels(this.defaultBuilder);
